...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [HideInInspector] public float GroundedOffset = -0.14f;

        [Tooltip("The radius of the grounded check. Should match the radius of the CharacterController")]
        [HideInInspector] public float GroundedRadius = 0.28f;
        ...
        [HideInInspector] public float TopClamp = 70.0f;

        [Tooltip("How far in degrees can you move the camera down")]
        [HideInInspector] public float BottomClamp = -30.0f;
        ...
        private void CameraRotation()
        {
            ...
            if (mouseInput.sqrMagnitude >= _threshold && !LockCameraPosition)
            {
                _cinemachineTargetYaw += mouseInput.x * CameraSensitivity;
                _cinemachineTargetPitch -= mouseInput.y * CameraSensitivity;
            }
        ...
        private void Move()
        {
            ...
            // set target speed based on movespeed
